// Legacy Support UI package.
// Kept for consumers that still depend on TanStack Solid Query / Solid 1 APIs.
...
export {
	...
	type CreateIssueFn,
} from "./components/create-issue-dialog.legacy";
export {
	ImageAttachButton,
...
} from "./components/issue-detail-page.legacy";
export {
	IssuesListPage,
	type IssuesListPageProps,
} from "./components/issues-list-page.legacy";
export {
	MarkdownBody,
