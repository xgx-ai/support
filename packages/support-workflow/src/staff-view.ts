...
const stateSummary: Record<WorkflowState, string> = {
	...
	implementing: "An agent is implementing the approved change",
	draft_pr_open: "A draft pull request is ready for independent QC",
	qc_running: "An independent agent is reviewing the exact candidate SHA",
	...
	verifying_staging: "An agent is verifying the merged SHA in staging",
	awaiting_deploy_approval: "Waiting for production deployment approval",
	deploying: "An agent is validating the approved deployment intent",
	deployment_pending: "The trusted deployment is queued or being reconciled",
	verifying_production: "An agent is verifying the deployed production SHA",
	response_drafting: "An agent is drafting a customer-safe response",
